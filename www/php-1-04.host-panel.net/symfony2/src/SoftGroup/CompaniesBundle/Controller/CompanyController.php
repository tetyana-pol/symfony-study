...
class CompanyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $companies = $em->getRepository('SoftGroupCompaniesBundle:Company')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('SoftGroup\CompaniesBundle\Form\CompanyType', $company);
...
$company->setCreatedAt($now);
    ...
    {
        $deleteForm = $this->createDeleteForm($company);
        $editForm = $this->createForm('SoftGroup\CompaniesBundle\Form\CompanyType', $company);
