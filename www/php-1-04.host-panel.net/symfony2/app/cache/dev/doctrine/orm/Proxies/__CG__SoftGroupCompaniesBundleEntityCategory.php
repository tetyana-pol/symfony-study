 ...
 */
class Category extends \SoftGroup\CompaniesBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'SoftGroup\\CompaniesBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'SoftGroup\\CompaniesBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'SoftGroup\\CompaniesBundle\\Entity\\Category' . "\0" . 'idParent', '' . "\0" . 'SoftGroup\\CompaniesBundle\\Entity\\Category' . "\0" . 'children', '' . "\0" . 'SoftGroup\\CompaniesBundle\\Entity\\Category' . "\0" . 'parent', '' . "\0" . 'SoftGroup\\CompaniesBundle\\Entity\\Category' . "\0" . 'createdAt', '' . "\0" . 'SoftGroup\\CompaniesBundle\\Entity\\Category' . "\0" . 'updatedAt');
        }
